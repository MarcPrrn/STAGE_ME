 ...
 */
final class Version20200812120204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE topics (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, subject VARCHAR(255) NOT NULL, edited_at DATETIME NOT NULL, content LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, pin TINYINT(1) NOT NULL, INDEX IDX_91F64639F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
